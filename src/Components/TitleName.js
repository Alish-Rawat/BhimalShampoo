...
const TitleName = () => {
  return (
    <div className="flex items-center justify-center gap-[18rem] bg-[#f0e1da] w-full h-[26rem] -translate-y-8">
      ...
      <div className=" w-[20rem] h-[20rem]  mt-10">
        ...
        <h2 className="flex justify-center mx-2 mt-2 p-1 font-serif sm:text-5xl text-3xl   font-bold">
          BHEEMAL &nbsp; SHAMPOO
        </h2>
      ...
      <div className=" w-[20rem] h-[20rem] -translate-y-4">
        <img className="w-[20rem] -translate-y-14" alt="pic" src={shampoo} />
      </div>
    </div>
  );
};
